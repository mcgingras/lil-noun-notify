        ...
        <>
          ...
          <div className="mt-1 relative">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="pl-0 absolute z-10 mt-1 w-full bg-white shadow-lg max-h-56 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                {traits.map((trait) => (
                  <Listbox.Option
                    key={trait.id}
                    className={({ active }) =>
